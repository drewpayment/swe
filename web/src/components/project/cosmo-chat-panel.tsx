...
export const CosmoChatPanel = memo(function CosmoChatPanel({
  ...
  return (
    <div className="flex flex-col w-2/5 min-w-[300px] max-w-[420px] shrink-0 h-full bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
      {/* Header */}
